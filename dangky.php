        ...
        $(function () {
            $("#tendangnhap").blur(function () {
                ...
                $.get("checkUsername.php",{un:u},function (data) {
                    if(data==0) {
                        $("#nhacLoiUn").html("<b>Tên hợp lệ !</b>");
                        $("#nhacLoiUn").css("color","green");
                    }else {
                        $("#nhacLoiUn").html("<b>Tên đã tồn tại !</b>");
...
<hr style="background: white ; margin-top: 80px">
<div class="container" style="margin-top: 90px;background: black">
    <h1 style="text-align: center;color: white">Đăng ký</h1>
    <form class="form-horizontal" action="themuser.php" method="post">
        <div class="form-group" style="background: black">
            <label style="color: white" class="control-label col-sm-2" for="email">Tên đăng nhập:</label>
            <div class="col-sm-10">
        ...
        <!--<div class="form-group">
            <label style="color: white" class="control-label col-sm-2" for="pwd">Nhập lại mật khẩu :</label>
            <div class="col-sm-10">
                <input type="password" class="form-control" id="nlpass" placeholder="Nhập lại mật khẩu.." name="nlpass">
            </div>
        </div>-->
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <div class="checkbox">
                    <label style="color: white"><input type="checkbox" name="remember"> Nhớ mật khẩu</label>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button id="btndk" name="btndk" type="submit" class="dky btn btn-default pull-right">Đăng ký</button>
            </div>
        </div>
    </form>
    <script>
